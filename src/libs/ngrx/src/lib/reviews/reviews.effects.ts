...
export class ReviewsEffects {
  $loadAllReviews = createEffect(() =>
    this._actions$.pipe(
      ...
      exhaustMap((queryParams) => {
        return this._reviewsService.getAllReviews(queryParams).pipe(
          map((reviewsResponse) => {
  ...
  $loadProductReviews = createEffect(() =>
    this._actions$.pipe(
      ...
      exhaustMap(({ productId, queryParams }) =>
        this._reviewsService.getProductReviews(productId, queryParams).pipe(
          map((reviewsResponse) => {
  ...
  $loadCustomerReviews = createEffect(() =>
    this._actions$.pipe(
      ...
      exhaustMap(({ customerId, queryParams }) =>
        this._reviewsService.getCustomerReviews(customerId, queryParams).pipe(
          map((reviewsResponse) => {
  ...
  $loadFavorites = createEffect(() =>
    this._actions$.pipe(
      ...
      exhaustMap(({ customerId }) =>
        this._reviewsService.getFavorites(customerId).pipe(
  ...
  $createReview = createEffect(() =>
    this._actions$.pipe(
      ofType(createReview),
      exhaustMap((payload) =>
        this._reviewsService.createReview(payload).pipe(
  ...
  $updateReview = createEffect(() =>
    this._actions$.pipe(
      ...
      exhaustMap(({ reviewId, requestBody }) => {
        return this._reviewsService.updateReview(reviewId, requestBody).pipe(
  ...
  $deleteReview = createEffect(() =>
    this._actions$.pipe(
      ofType(deleteReview),
      exhaustMap(({ reviewId }) =>
        this._reviewsService.deleteReview(reviewId).pipe(
